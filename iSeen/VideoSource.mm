...
- (id)init {
    ...
    if ( self ) {
        ...
        if ( [captureSession canSetSessionPreset:AVCaptureSessionPresetHigh] ) {
            ...
            NSLog(@"Capturing video at high quality.");
        } else {
...
//when instance of VideoSource class is deallocated, we stop captureSession as well.
- (void)dealloc {
...
//returns the specified camera device (front/rear cam)
